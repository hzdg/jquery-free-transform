(function($){
	...
	function _init(sel, options){
		...
		// translate (aka move)
		container.bind('mousedown.freetrans', _noSelect(_ifLeft(function(evt) {
		...
		// rotate
		rotator.bind('mousedown.freetrans', _noSelect(_ifLeft(function(evt) {
			evt.stopPropagation();
		...
		// scale
		container.find('.ft-scaler').bind('mousedown.freetrans', _noSelect(_ifLeft(function(evt) {
			evt.stopPropagation();
